...
In order to support loading of multiple wallets in soverain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is soverain.cpp.
...
Changes to soverain.cpp
----------------------
soverain.cpp is the entry point into soverain-qt, and as such, will require some minor modifications to provide hooks for
