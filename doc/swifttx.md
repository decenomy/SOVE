...
* WebSocket: [https://github.com/soverainproject/insight-api-soverain#web-socket-api](https://github.com/soverainproject/insight-api-soverain#web-socket-api) 
* API: [https://github.com/soverainproject/insight-api-soverain#swifttx-transactions](https://github.com/soverainproject/insight-api-soverain#swifttx-transactions) 
...
By default, the Soverain Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Soverain Core daemon:
