...
RESOURCES += src/qt/soverain.qrc src/qt/soverain_locale.qrc

TRANSLATIONS += src/qt/locale/soverain_bg.ts \
                src/qt/locale/soverain_de.ts \
                src/qt/locale/soverain_en.ts \
                src/qt/locale/soverain_es.ts \
                src/qt/locale/soverain_fi.ts \
                src/qt/locale/soverain_fr.ts \
                src/qt/locale/soverain_it.ts \
                src/qt/locale/soverain_ja.ts \
                src/qt/locale/soverain_pl.ts \
                src/qt/locale/soverain_pt.ts \
                src/qt/locale/soverain_ru.ts \
                src/qt/locale/soverain_sk.ts \
                src/qt/locale/soverain_sv.ts \
                src/qt/locale/soverain_vi.ts \
                src/qt/locale/soverain_zh_CN.ts \
                src/qt/locale/soverain_zh_TW.ts
