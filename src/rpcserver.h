...
/**
 * Soverain RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue setzsoveseed(const UniValue& params, bool fHelp);
extern UniValue getzsoveseed(const UniValue& params, bool fHelp);
