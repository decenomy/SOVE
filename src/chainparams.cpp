...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000007cabcfba44b7a728f1746bdec842c9fefab32e8e9df3e18d28ecc265eb3"))
                              (1500, uint256("0x8546dd7c949bde80fb841f7eff8b7ff2769e0340af6f3409aeeeaa92e3a1a155"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1566236609, // * UNIX timestamp of last checkpoint block
    2004,       // * total number of transactions between genesis and last checkpoint
                //   (the tx=... number in the SetBestChain debug.log lines)
    6250        // * estimated number of transactions per day after checkpoint
};
...
public:
    CMainParams()
    {
         ...
         */
        pchMessageStart[0] = 0x53; //SOVE
        pchMessageStart[1] = 0x4f;
        pchMessageStart[2] = 0x56;
        pchMessageStart[3] = 0x45;
        vAlertPubKey = ParseHex("04e3fd38eef6299e247d07490498f5880db2ddb53320619a63ad32d3a33e3e329e7eb41fe43fb56b5127ed5835cac16347903ecd4b38a062e700156b002e3d8c4c");
        nDefaultPort = 18976;
        ...
        nMinerThreads = 0;
        nTargetTimespan = 60;  // Soverain: 1  min
        nTargetSpacing =  30;  // Soverain: 30 sec
        nMaturity = 120;
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1563924366; //07/23/2019 @ 11:26pm (UTC)
        genesis.nBits = 0x1e0fffff;
        genesis.nNonce = 694507;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000007cabcfba44b7a728f1746bdec842c9fefab32e8e9df3e18d28ecc265eb3"));
        assert(genesis.hashMerkleRoot == uint256("0x79b352ef6aa3a1994a4c3d711e2d460385b53cce065611049a9a3c55e49b53e1"));
        ...
        strSporkKey = "04c90538206b7c4921e1e96e93e83dcc39f4351b997fc57934f5beddf916563497b99a315a772b626e072c9a903209c85172cec7052a54739dc392e27cda0d581f";
        strObfuscationPoolDummyAddress = "ScAUM5KF8zHjPcWX3wpFkajfxnRMwESiNa";
