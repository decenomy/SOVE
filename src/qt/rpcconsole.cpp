                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzsovePathCustom = GetArg("-zsovebackuppath", "");
    ...
    if(!strzsovePathCustom.empty()) {
        ui->wallet_customzsovebackuppath->setText(QString::fromStdString(strzsovePathCustom));
        ui->wallet_customzsovebackuppath_label->setVisible(true);
        ui->wallet_customzsovebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzsovePathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Soverain RPC console.") + "<br>" +
