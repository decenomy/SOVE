...
/* Soverain GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Soverain"
#define QAPP_ORG_DOMAIN "soverain.org"
#define QAPP_APP_NAME_DEFAULT "Soverain-Qt"
#define QAPP_APP_NAME_TESTNET "Soverain-Qt-testnet"
