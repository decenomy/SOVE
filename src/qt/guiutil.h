...
/** Utility functions used by the Soverain Qt UI.
 */
namespace GUIUtil
{
...
// Render Soverain addresses in monospace font
...
// Parse "soverain:" URI into recipient object, return true on successful parsing
