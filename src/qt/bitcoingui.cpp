                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Soverain Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Soverain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and soverain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSOVE"));
...
//    tabGroup->addAction(proposalAction);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Soverain Core"), this);
    aboutAction->setStatusTip(tr("Show information about Soverain Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Soverain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Soverain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Soverain addresses"));
    ...
    openAction->setStatusTip(tr("Open a Soverain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Soverain Core help message to get a list with possible Soverain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Soverain Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Soverain network", "", count));
}
...
{
    QString strTitle = tr("Soverain Core"); // default title
