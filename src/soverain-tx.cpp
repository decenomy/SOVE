...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Soverain Core soverain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  soverain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded soverain transaction") + "\n" +
                               "  soverain-tx [options] -create [commands]   " + _("Create hex-encoded soverain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded soverain transaction
