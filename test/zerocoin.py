...
#   c) node1 mines 32 blocks, so now node 0 has 60001sove, node 1 has 4250sove, node2 has none.
#   d) node0 sends 601 sove to node2, in two transactions (301 sove, then 300 sove).
