Contributing to Soverain Core
============================

The Soverain Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Soverain Core project, and is not to be
confused with overall Soverain Network Protocol consensus changes.

Whether a pull request is merged into Soverain Core rests with the project merge
...
Patches that change Soverain consensus rules are considerably more involved than
...
Where a patch set proposes to change the Soverain consensus, it must have been
...
The project leader is the release manager for each Soverain Core release.
